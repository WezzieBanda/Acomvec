...
output_control1 <- run_simulation(timesteps = parameters$timesteps, parameters = site_par)
...
target_days <- c(1 , 2190)  # mid-year of years 1, 2, 3
target_pfpr <- c(0.45, 0.465)  # desired PfPR at these days
#0.468/
...
site_par <- site_parameters(
  ...
  clinical_incidence = c(0.5, 100) * 365,
  prevalence = c(0, 100)*365 # add prevalence here
)
