...
parameters <- set_bednets(
  ...
  rn = matrix(c(0.64, 0.64,0.64,
                0.64, 0.64, 0.64),nrow = 2,ncol = 3,byrow = TRUE),
  rnm = matrix(c(0.24, 0.24, 0.24,
                 0.24, 0.24, 0.24),nrow = 2,ncol = 3,byrow = TRUE),
...
#0.468
target_pfpr <- c(0.445, 0.435)  # desired PfPR at these days
...
plot_combined_prevalence_all <- function() {
  # -----------------------------
  slice_start <- 1977
  cols <- c("darkgreen", "darkblue",  "black", "darkred","black")
...
parameters <- set_bednets(
  ...
  rnm = matrix(c(0.24, 0.24, 0.24,
                 0.24, 0.24, 0.24),nrow = 2,ncol = 3,byrow = TRUE),
  gamman = rep(c(1.85 ,2.56)*365) # Vector of bed net half-lives for each distribution timestep
)
...
target_pfpr <- c(0.465, 0.46) #model 9
#target_pfpr <- c(0.475, 0.465) #model 2
...
parameters <- set_bednets(
  ...
  rnm = matrix(c(0.24, 0.24, 0.24,
                 0.24, 0.24, 0.24),nrow = 2,ncol = 3,byrow = TRUE),
  gamman = rep(c(1.85, 1.85) * 365) # Vector of bed net half-lives for each distribution timestep
)
